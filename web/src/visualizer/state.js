...
const SAFE_PROJECT_DATA =
  PROJECT_DATA &&
  typeof PROJECT_DATA === 'object' &&
  Array.isArray(PROJECT_DATA.nodes) &&
  Array.isArray(PROJECT_DATA.edges)
    ? PROJECT_DATA
    : { nodes: [], edges: [] };
...
export const nodes = SAFE_PROJECT_DATA.nodes.map((n, i) => ({
  ...n,
  x: 0,
  y: 0,
...
export const edges = SAFE_PROJECT_DATA.edges;
